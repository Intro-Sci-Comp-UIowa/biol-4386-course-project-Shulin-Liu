...
# AD numerized
colorsChoice <- colorRampPalette(c("red", "black", "green"))
col=colorsChoice(20)
print(col)
col2 <- c("#FF0000", "#E40000", "#C90000", "#AE0000", "#930000", "#780000", "#5D0000", "#005D00", "#007800", "#009300", "#00AE00", "#00C900", "#00E400", "#00FF00")
...
heatmap.2(ADmap, Rowv = FALSE, Colv = FALSE, dendrogram = "none", col = col2, symbreaks = any(ADmap < 0, na.rm=TRUE) || scale!="none", rowsep = c(16, 26) ,cexRow = 0.5,  cexCol = 1, srtCol = 0, colRow = ColorAD, RowSideColors = Bar, lhei = c(0.2,0.5), keysize = 1.4, adjCol = c(0.5,1), density.info="histogram", trace = "none", main = "Expression of genes significantly differentially \n expressed across all AD brain regions", xlab = "Brain Region", ylab = "Gene")
dev.off()
```